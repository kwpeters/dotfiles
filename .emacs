...
;;
;; Figured out how to customize these faces here:
;; https://www.reddit.com/r/emacs/comments/rg9ojl/a_workflow_to_quickly_change_orgmode_section/
;;
;; This code utilizes color schemes generated by the coolors.co website.  An example scheme:
;; https://coolors.co/6690cc-653fc4-f18f01-b6c9bb-bfedc1
;;
;; Some notes about choosing colors:
;; - Stay away from red and green.  Those colors are used for TODO state and priority state.
...
(custom-set-faces
  ...
  ;; Note: The face org-level-9 does not exist. Org-mode repeats the set of 8.
  )
